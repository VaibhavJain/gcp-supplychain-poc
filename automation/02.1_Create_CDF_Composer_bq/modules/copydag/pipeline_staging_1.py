...
with models.DAG(
...
) as Pipeline_Staging_L0_Full:
    
    start=DummyOperator(task_id='START')
    
    end=DummyOperator(task_id='END')
    
    with TaskGroup(group_id='Staging_Group_1') as tg1:
    ...
    with TaskGroup(group_id='Staging_Group_2') as tg2:
    ...
    Pipeline21 >> Pipeline22 >> Pipeline23 >> Pipeline24 >> Pipeline25 >> Pipeline26
    Pipeline27 >> Pipeline28 >> Pipeline29 >> Pipeline30 >> Pipeline31 
