CREATE TABLE `{$projectid}.{$slt_l2_canonical}.product`
(
  ...
  shelf_life NUMERIC OPTIONS(description="Shelf_Life of the Product"),
  product_classification STRING OPTIONS(description="ABC Classification for KPI analysis"),
  safty_stock NUMERIC OPTIONS(description="Safety Stock"),
...
CREATE TABLE `{$projectid}.{$slt_l2_canonical}.location`
(
  uuid STRING OPTIONS(description="Universal Unique ID"),
...
CREATE TABLE `{$projectid}.{$slt_l2_canonical}.legal_entity`
(
...
CREATE TABLE `{$projectid}.{$slt_l2_canonical}.asset`
(
...
CREATE TABLE `{$projectid}.{$slt_l2_canonical}.order`
(
...
CREATE TABLE `{$projectid}.{$slt_l2_canonical}.forecast`
(
...
CREATE TABLE `{$projectid}.{$slt_l2_canonical}.inventory`
(
